...
namespace OOP_lab_4
{
    public class Triangle : DisplayObject
    {
        ...
        public Triangle(int X, int Y,int x1, int y1,  int speed, double angle, int boost, int[] fillColor, int[] borderColor, int borderSize, int x2, int y2, int x3, int y3) : base(X, Y,fillColor, borderColor, borderSize, speed, angle, boost)
        {
            _X1 = x1;
            _Y1 = y1;
            _X2 = x2;
